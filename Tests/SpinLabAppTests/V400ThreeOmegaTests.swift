...
struct V400WorkspaceStoreTests {
    ...
    func initialState() {
        ...
        #expect(store.tabs.output(for: .rahe3omegaVsT).imageData == nil)
        #expect(store.tabs.output(for: .hcVsT).imageData == nil)
        #expect(store.tabs.output(for: .rtCurve).imageData == nil)
        #expect(store.tabs.output(for: .scaling).imageData == nil)
