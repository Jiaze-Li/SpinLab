...
struct PlotSystemSeriesControlModelRegressionTests {
    ...
    func reorderKeepsSemanticLabels() throws {
        ...
        let renderOrder = ThreeOmegaWorkspaceStore.legacyRendererBottomToTopOrder(fromVisualOrder: reordered.items.map(\.identityKey))
        ...
        let orderedSweeps = ThreeOmegaWorkspaceStore._legacyApplyRawSweepOrder(renderOrder, to: sweeps)
    ...
    func threeOmegaFieldSweepIdentityMappingUsesStableKeys() throws {
        ...
        let renderOrder = ThreeOmegaWorkspaceStore.legacyRendererBottomToTopOrder(fromVisualOrder: visualKeys)
        ...
        let reorderedRenderOrder = ThreeOmegaWorkspaceStore.legacyRendererBottomToTopOrder(fromVisualOrder: reorderedVisualKeys)
        let reorderedSweeps = ThreeOmegaWorkspaceStore._legacyApplyRawSweepOrder(reorderedRenderOrder, to: sweeps)
